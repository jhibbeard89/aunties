...
user = User.new(
  ...
  first_name: 'Sam',
  last_name: 'Hawkins',
  address: '71 Schillerstr, Berlin, 10627 ',
...
user = User.new(
  ...
  first_name: 'Andrew',
  last_name: 'Cox',
  address: '13 Grolmanstr, Berlin, 10623',
  phone_number: '+1 417 234 1123',
  auntie: true
)
...
user = User.new(
  ...
  first_name: 'Pauline',
  last_name: 'Lane',
  address: '13 Wilsnackerstr, Berlin, 10559',
  phone_number: '+1 417 234 1123',
  auntie: true
)
...
user = User.new(
  ...
  first_name: 'India',
  last_name: 'Smith',
  address: 'Gerhardtstraße 1, Berlin, 10557',
  phone_number: '+1 417 234 1123',
  auntie: false
)
...
meal = Meal.new(
  ...
  address: 'Habersaathstraße 13, 10115 Berlin',
  price: rand(4..12),
  quantity: rand(2..10),
  user: User.find(2)
)
...
meal = Meal.new(
  ...
  address: 'Habersaathstrasse 13, 10115 Berlin',
  price: rand(4..12),
  quantity: rand(2..10),
  user: User.find(3)
)
...
meal = Meal.new(
  ...
  address: 'Tuchollapl. 2, 10317 Berlin',
  price: rand(4..12),
  quantity: rand(2..10),
  user: User.find(2)
)
